...
/**
 * 可随手指的拖拽一起移动的 Button (草稿3, 仅供演示该控件功能的一步步完善, bug的一步步修复, 扩展性的一步步增强的过程)
 *
 * @author zhangzhiyi
 * @version 1.0
 * @createTime 2016/4/2 22:43
 */
public class DragAndMoveButton3 extends Button {
    ...
    public DragAndMoveButton3(Context context) {
        super(context);
        init();
    }

    public DragAndMoveButton3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DragAndMoveButton3(Context context, AttributeSet attrs, int defStyleAttr) {
